...
import { Users, Bot, Activity, ArrowRight, Plus } from 'lucide-react'
...
export function DashboardPage() {
  ...
  const cards = [
    ...
    { label: 'Automações ativas', value: stats.automacoesAtivas, icon: Bot, to: '/automacoes', color: 'bg-green-50 text-green-600' },
